#include "../nunavut_out/nova/motor_driver/Command_1_0.h"
#include "nova_can.h"
...
int main() {
    ...
    nova_can_add_rx(&nova_can, //pointer to the nova_can struct
                    50, //Subject ID
                    motor_driver_command_callback, //the command callback
    );
